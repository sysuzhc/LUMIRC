...
function [x, e, nIter, nIterInner, timeSteps, lambda_out] = SolvePALM_CBM(A, b, mu, x_init, maxIter_in, lambda_in, varargin)
...
while ~converged_main
    ...
    nIterInner = nIterInner + nIter_apg;
